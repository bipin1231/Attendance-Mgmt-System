       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
               <li class="breadcrumb-item">  <div class="row"><a href="viewStudentAttendance.php">
                    <button type="submit" name="go" class="btn btn-primary">View Attendance</button>
...
<!--                     
                    ...
                    <form action="viewStudents.php" method="get">             
                        <select name="search" class="form-control mb-3" id="search">
                        <option value="">Search Record</option>
                         <?php 
                         $semquery="SELECT * FROM student";
                         $semresult=mysqli_query($conn,$semquery);
                     ...
                     tableData($num,$result);
                      ...
                      tableData($num,$result);
                        ...
                        if(isset($_GET['searchRecord'])){
                          ...
                          $query="SELECT * FROM student where registration='$search' or fname='$search'";
                          $result=mysqli_query($conn,$query);  
                          $num=mysqli_num_rows($result);
                          //echo 'hello';
                          tableData($num,$result);
