               ...
               ?>
                ...
                <form action="" method="post">
                  ...
                  <?php
                    ...
                    if(empty($user_semester) && empty($user_section) && empty($user_bookName)){
                      $query="SELECT * FROM student natural join attendancePercentage where teacherID='$teacher_id'";
                    ...
                    else if(isset($user_semester) && empty($user_section) && empty($user_bookName)){
                      $query="SELECT * FROM student natural join attendancePercentage where teacherID='$teacher_id' and semester='$user_semester'";
                      $result=mysqli_query($conn,$query);
                      $num=mysqli_num_rows($result);
                      tableData($num,$result);
                    }
                    else if(isset($user_section) && empty($user_semester) && empty($user_bookName)){
                      $query="SELECT * FROM studentnatural join attendancePercentage where teacherID='$teacher_id' and section='$user_section'";
                      $result=mysqli_query($conn,$query);
                      $num=mysqli_num_rows($result);
                      tableData($num,$result);
                    }
                      ...
                      $query="select * from student natural join attendancePercentage where teacherID='$teacher_id' and subject='$user_bookName'";
                      $result=mysqli_query($conn,$query);
                      $num=mysqli_num_rows($result);
                      tableData($num,$result);
